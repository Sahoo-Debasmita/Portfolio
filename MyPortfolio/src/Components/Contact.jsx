      ...
      <div className='max-w-screen-lg p-4 flex flex-col justify-center mx-auto h-full'>
        ...
        <div className='flex justify-center items-center'>
            <form action="https://getform.io/f/b09d07c2-20ec-43ef-b4ce-512d6b92e11b" method='POST' className='flex flex-col w-full md:w-1/2'>
                <input type="text" name='name' placeholder='Enter your name here' className='p-2 focus:outline-none bg-transparent border-2 rounded-md text-white' />
                <input type="email" name='email' placeholder='Enter your E-Mail here' className='p-2 my-4 focus:outline-none bg-transparent border-2 rounded-md text-white' />
